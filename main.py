...
if __name__ == "__main__":
    ...
    fig = plt.figure(figsize=(12,6),num='Least squares problem for N=8')
    ...
    print('\n--- Fitted polynomials with the use of least squares ---')
    print('-------------- Number of training points N=50. --------------')
    fig = plt.figure(figsize=(12, 6),num='Least squares problem for N=50')
    ...
    # Selekcja modelu
    print('\n--- Model selection for linear least squares ---')
    print('---------------- Polynomial models of degree M=0,...,7 ----------------')
    print('- Number of training points N=50. Number of validation points N=20 -')
    ...
    fig = plt.figure(figsize=(6, 5),num='Model selection for M')
    ...
    print('\n--- Model selection for linear least squares with regularization ---')
    print('-- Degree M=7. Number of training points N=50. Number of validation points N=20 --')
    ...
    fig = plt.figure(figsize=(6, 5), num='Selection of regularization coefficient')
    sub = fig.add_subplot(1, 1, 1)
